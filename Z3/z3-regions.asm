    ...
    REG_CUSTOM_ROUTE_MENU_AREA equ 0x380
    ...
    REG_CUSTOM_ROUTE_MENU_LV4_PRINTING equ REG_CUSTOM_ROUTE_MENU_LV4 + REG_CUSTOM_ROUTE_MENU_LV4_AREA
    REG_CUSTOM_ROUTE_MENU_LV4_PRINTING_AREA equ 0x300
    REG_CUSTOM_ROUTE_MENU_LV4_ENTRIES equ REG_CUSTOM_ROUTE_MENU_LV4_PRINTING + REG_CUSTOM_ROUTE_MENU_LV4_PRINTING_AREA
    REG_CUSTOM_ROUTE_MENU_LV4_ENTRIES_AREA equ 0x280
    REG_CUSTOM_ROUTE_MENU_LV4_ENTRY_DATA equ REG_CUSTOM_ROUTE_MENU_LV4_ENTRIES + REG_CUSTOM_ROUTE_MENU_LV4_ENTRIES_AREA
    REG_CUSTOM_ROUTE_MENU_LV4_ENTRY_DATA_AREA equ 0x100
    REG_CUSTOM_ROUTE_MENU_STAGE_UNLOCKS equ REG_CUSTOM_ROUTE_MENU_LV4_ENTRY_DATA + REG_CUSTOM_ROUTE_MENU_LV4_ENTRY_DATA_AREA
    REG_CUSTOM_ROUTE_MENU_STAGE_UNLOCKS_AREA equ 0x100
    REG_CUSTOM_ROUTE_MENU_LVX equ REG_CUSTOM_ROUTE_MENU_STAGE_UNLOCKS + REG_CUSTOM_ROUTE_MENU_STAGE_UNLOCKS_AREA
    REG_CUSTOM_ROUTE_MENU_LVX_AREA equ 0x260
    REG_CUSTOM_ROUTE_MENU_LVX_ENTRIES equ REG_CUSTOM_ROUTE_MENU_LVX + REG_CUSTOM_ROUTE_MENU_LVX_AREA
    REG_CUSTOM_ROUTE_MENU_LVX_ENTRIES_AREA equ 0x140