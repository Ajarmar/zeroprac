    ...
    REG_CHECKPOINTS_INSTR equ REG_CHECKPOINTS + REG_CHECKPOINTS_AREA
    REG_CHECKPOINTS_INSTR_AREA equ 0x100
    REG_STAGE_SELECT_ENTRIES equ REG_CHECKPOINTS_INSTR + REG_CHECKPOINTS_INSTR_AREA
